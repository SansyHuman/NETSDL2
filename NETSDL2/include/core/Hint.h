...
namespace NETSDL2
{
	...
	{
#ifndef MAKE_HINT
#define MAKE_HINT(name) static initonly SDLHint H_##name = SDLHint(SDL_HINT_##name)
#endif

		/// <summary>
		/// All SDL hint names.
		/// </summary>
		public value struct SDLHint
		{
		internal:
			System::String^ name;
		...
		public:
			...
			/// </summary>
			MAKE_HINT(ACCELEROMETER_AS_JOYSTICK);
			...
			/// </summary>
			MAKE_HINT(ALLOW_ALT_TAB_WHILE_GRABBED);
			...
			///   "1"       - allow topmost
			/// </summary>
			MAKE_HINT(ALLOW_TOPMOST);

			/// <summary>
			/// Android APK expansion main file version. Should be a string number like "1", "2"
			/// etc.
			/// 
			...
			/// </summary>
			MAKE_HINT(ANDROID_APK_EXPANSION_MAIN_FILE_VERSION);

			/// <summary>
			/// \brief Android APK expansion patch file version. Should be a string number like "1", "2"
			/// etc.
			/// 
			...
			/// By default this hint is not set and the APK expansion files are not searched.
			/// </summary>
			MAKE_HINT(ANDROID_APK_EXPANSION_PATCH_FILE_VERSION);
			...
			/// </summary>
			MAKE_HINT(ANDROID_BLOCK_ON_PAUSE);
			...
			/// The value should be set before SDL is initialized.
			/// </summary>
			MAKE_HINT(ANDROID_BLOCK_ON_PAUSE_PAUSEAUDIO);
			...
			/// </summary>
			MAKE_HINT(ANDROID_TRAP_BACK_BUTTON);
			...
			/// </summary>
			MAKE_HINT(APPLE_TV_CONTROLLER_UI_EVENTS);
			...
			/// </summary>
			MAKE_HINT(APPLE_TV_REMOTE_ALLOW_ROTATION);
			...
			///  This variable can be set to the following values:
			/// 
			///    "ambient"     - Use the AVAudioSessionCategoryAmbient audio category, will be muted by
			/// the phone mute switch (default)
			///    "playback"    - Use the AVAudioSessionCategoryPlayback category
			/// 
			///  For more information, see Apple's documentation:
			///  https://developer.apple.com/library/content/documentation/Audio/Conceptual/AudioSessionProgrammingGuide/AudioSessionCategoriesandModes/AudioSessionCategoriesandModes.html
			/// </summary>
			MAKE_HINT(AUDIO_CATEGORY);
			...
			/// On targets where this is not supported, this hint does nothing.
			/// </summary>
			MAKE_HINT(AUDIO_DEVICE_APP_NAME);
			...
			/// On targets where this is not supported, this hint does nothing.
			/// </summary>
			MAKE_HINT(AUDIO_DEVICE_STREAM_NAME);
			...
			/// On targets where this is not supported, this hint does nothing.
			/// </summary>
			MAKE_HINT(AUDIO_DEVICE_STREAM_ROLE);
			...
			/// </summary>
			MAKE_HINT(AUDIO_RESAMPLING_MODE);

			/// <summary>
			/// \brief  A variable controlling whether SDL updates joystick state when getting input
			/// events
			/// 
			/// This variable can be set to the following values:
			/// 
			...
			/// </summary>
			MAKE_HINT(AUTO_UPDATE_JOYSTICKS);
			...
			/// </summary>
			MAKE_HINT(BMP_SAVE_LEGACY_FORMAT);
			...
			/// </summary>
			MAKE_HINT(DISPLAY_USABLE_BOUNDS);
			...
			/// 
			/// The variable can be set to the following values:
			///    "0"       - Disable emscripten_sleep calls (if you give back browser control manually
			/// or use asyncify for other purposes)
			///    "1"       - Enable emscripten_sleep calls (the default)
			/// </summary>
			MAKE_HINT(EMSCRIPTEN_ASYNCIFY);
			...
			///    any other string without a leading # sign applies to the element on the page with that
			/// ID.
			/// </summary>
			MAKE_HINT(EMSCRIPTEN_KEYBOARD_ELEMENT);

			/// <summary>
			/// \brief  A variable that controls whether Steam Controllers should be exposed using the
			/// SDL joystick and
			...
			/// subsystem.
			/// </summary>
			MAKE_HINT(ENABLE_STEAM_CONTROLLERS);

			/// <summary>
			///  \brief  A variable controlling verbosity of the logging of SDL events pushed onto the
			/// internal queue.
			/// 
			...
			/// </summary>
			MAKE_HINT(FORCE_RAISEWINDOW);

			/// <summary>
			///  \brief  A variable controlling how 3D acceleration is used to accelerate the SDL screen
			/// surface.
			/// 
			...
			/// </summary>
			MAKE_HINT(FRAMEBUFFER_ACCELERATION);
			...
			/// </summary>
			/// <param name=""></param>
			MAKE_HINT(GAMECONTROLLERCONFIG);
			...
			/// SDL_GameControllerMappingForGUID() and SDL_GameControllerAddMapping()
			/// </summary>
			MAKE_HINT(GAMECONTROLLERCONFIG_FILE);
			...
			///      SwitchPro
			/// 
			///  This hint affects what driver is used, and must be set before calling SDL_Init
			/// (SDL_INIT_GAMECONTROLLER)
			/// </summary>
			MAKE_HINT(GAMECONTROLLERTYPE);
			...
			/// </summary>
			MAKE_HINT(GAMECONTROLLER_IGNORE_DEVICES);
			...
			///  file will be loaded and interpreted as the value of the variable.
			/// </summary>
			MAKE_HINT(GAMECONTROLLER_IGNORE_DEVICES_EXCEPT);

			/// <summary>
			///  \brief  If set, game controller face buttons report their values according to their
			/// labels instead of
			...
			/// </summary>
			MAKE_HINT(GAMECONTROLLER_USE_BUTTON_LABELS);
			...
			/// </summary>
			MAKE_HINT(IDLE_TIMER_DISABLED);

			/// <summary>
			/// \brief A variable to control whether certain IMEs should handle text editing internally
			/// instead of sending SDL_TEXTEDITING events.
			/// 
			/// The variable can be set to the following values:
			...
			/// </summary>
			MAKE_HINT(IME_INTERNAL_EDITING);

			/// <summary>
			/// \brief A variable to control whether certain IMEs should show native UI components (such
			/// as the Candidate List) instead of suppressing them.
			/// 
			/// The variable can be set to the following values:
			///   "0"       - Native UI components are not display. (default)
			///   "1"       - Native UI components are displayed.
			/// </summary>
			MAKE_HINT(IME_SHOW_UI);

			/// <summary>
			/// \brief A variable to control if extended IME text support is enabled.
			/// If enabled then SDL_TextEditingExtEvent will be issued if the text would be truncated
			/// otherwise.
			/// Additionally SDL_TextInputEvent will be dispatched multiple times so that it is not
			/// truncated.
			/// 
			/// The variable can be set to the following values:
			...
			/// </summary>
			/// <param name=""></param>
			MAKE_HINT(IME_SUPPORT_EXTENDED_TEXT);
			...
			/// </summary>
			MAKE_HINT(IOS_HIDE_HOME_INDICATOR);

			/// <summary>
			///  \brief  A variable that lets you enable joystick (and gamecontroller) events even when
			...
			/// </summary>
			MAKE_HINT(JOYSTICK_ALLOW_BACKGROUND_EVENTS);
			...
			/// below.
			/// </summary>
			MAKE_HINT(JOYSTICK_HIDAPI);

			/// <summary>
			///  \brief  A variable controlling whether the HIDAPI driver for Nintendo GameCube
			...
			/// </summary>
			MAKE_HINT(JOYSTICK_HIDAPI_GAMECUBE);

			/// <summary>
			///  \brief  A variable controlling whether "low_frequency_rumble" and "high_frequency_rumble"
			...
			/// </summary>
			MAKE_HINT(JOYSTICK_GAMECUBE_RUMBLE_BRAKE);

			/// <summary>
			/// \brief  A variable controlling whether the HIDAPI driver for Nintendo Switch Joy-Cons
			/// should be used.
			/// 
			/// This variable can be set to the following values:
			///   "0"       - HIDAPI driver is not used
			...
			/// The default is the value of SDL_HINT_JOYSTICK_HIDAPI
			/// </summary>
			MAKE_HINT(JOYSTICK_HIDAPI_JOY_CONS);

			/// <summary>
			///  \brief  A variable controlling whether Nintendo Switch Joy-Con controllers will be
			...
			/// </summary>
			MAKE_HINT(JOYSTICK_HIDAPI_COMBINE_JOY_CONS);
			...
			///  The default is the value of SDL_HINT_JOYSTICK_HIDAPI
			/// </summary>
			MAKE_HINT(JOYSTICK_HIDAPI_LUNA);
			...
			///  The default is the value of SDL_HINT_JOYSTICK_HIDAPI
			/// </summary>
			MAKE_HINT(JOYSTICK_HIDAPI_NINTENDO_CLASSIC);
			...
			/// The default is the value of SDL_HINT_JOYSTICK_HIDAPI
			/// </summary>
			MAKE_HINT(JOYSTICK_HIDAPI_SHIELD);
			...
			/// </summary>
			MAKE_HINT(JOYSTICK_HIDAPI_PS4_RUMBLE);
			...
			/// </summary>
			MAKE_HINT(JOYSTICK_HIDAPI_PS5_PLAYER_LED);
			...
			/// </summary>
			MAKE_HINT(JOYSTICK_HIDAPI_PS5_RUMBLE);
			...
			///  The default is the value of SDL_HINT_JOYSTICK_HIDAPI
			/// </summary>
			MAKE_HINT(JOYSTICK_HIDAPI_STADIA);
			...
			/// The default is "0"
			/// </summary>
			MAKE_HINT(JOYSTICK_HIDAPI_STEAM);
			...
			/// </summary>
			/// <param name=""></param>
			MAKE_HINT(JOYSTICK_HIDAPI_SWITCH);
			...
			///  By default the Home button LED state is not changed. This hint can also be set to a floating point value between 0.0 and 1.0 which controls the brightness of the Home button LED.
			/// </summary>
			MAKE_HINT(JOYSTICK_HIDAPI_JOYCON_HOME_LED);
			...
			///    "1"       - player LEDs are enabled (the default)
			/// </summary>
			MAKE_HINT(JOYSTICK_HIDAPI_SWITCH_PLAYER_LED);
			...
			/// </summary>
			MAKE_HINT(JOYSTICK_HIDAPI_XBOX);
			...
			/// </summary>
			MAKE_HINT(JOYSTICK_RAWINPUT_CORRELATE_XINPUT);
			...
			/// </summary>
			MAKE_HINT(JOYSTICK_ROG_CHAKRAM);
			...
			/// </summary>
			MAKE_HINT(KMSDRM_REQUIRE_DRM_MASTER);
			...
			/// </summary>
			MAKE_HINT(LINUX_DIGITAL_HATS);

			/// <summary>
			///  \brief  A variable controlling whether digital hats on Linux will apply deadzones to their underlying
			/// input axes or use unfiltered values.
			/// 
			///  This variable can be set to the following values:
			///    "0"       - Return digital hat values based on unfiltered input axis values
			///    "1"       - Return digital hat values with deadzones on the input axes taken into account (the default)
			/// </summary>
			MAKE_HINT(LINUX_HAT_DEADZONES);
			...
			/// </summary>
			MAKE_HINT(LINUX_JOYSTICK_CLASSIC);
			...
			/// </summary>
			MAKE_HINT(LINUX_JOYSTICK_DEADZONES);
			...
			/// </summary>
			/// <param name=""></param>
			MAKE_HINT(MAC_CTRL_CLICK_EMULATE_RIGHT_CLICK);
			...
			/// </summary>
			MAKE_HINT(MAC_OPENGL_ASYNC_DISPATCH);

			/// <summary>
			/// \brief  A variable setting the double click radius, in pixels.
			/// </summary>
			MAKE_HINT(MOUSE_DOUBLE_CLICK_RADIUS);

			/// <summary>
			/// \brief  A variable setting the double click time, in milliseconds.
			/// </summary>
			/// <param name=""></param>
			MAKE_HINT(MOUSE_DOUBLE_CLICK_TIME);
			...
			/// </summary>
			MAKE_HINT(MOUSE_RELATIVE_MODE_CENTER);
			...
			/// </summary>
			MAKE_HINT(MOUSE_RELATIVE_MODE_WARP);
			...
			/// </summary>
			MAKE_HINT(MOUSE_RELATIVE_SCALING);

			/// <summary>
			/// \brief  A variable setting the scale for mouse motion, in floating point, when the mouse is in relative mode
			/// </summary>
			MAKE_HINT(MOUSE_RELATIVE_SPEED_SCALE);
			...
			/// </summary>
			MAKE_HINT(MOUSE_RELATIVE_WARP_MOTION);
			...
			/// </summary>
			MAKE_HINT(QTWAYLAND_CONTENT_ORIENTATION);
			...
			/// </summary>
			MAKE_HINT(QTWAYLAND_WINDOW_FLAGS);
			...
			/// </summary>
			MAKE_HINT(RENDER_DIRECT3D11_DEBUG);
			...
			/// </summary>
			MAKE_HINT(RENDER_DIRECT3D_THREADSAFE);
			...
			/// </summary>
			MAKE_HINT(RENDER_LOGICAL_SIZE_MODE);
			...
			/// </summary>
			MAKE_HINT(RENDER_OPENGL_SHADERS);
			...
			/// </summary>
			MAKE_HINT(RENDER_SCALE_QUALITY);
			...
			/// The value of this hint is used at runtime, so it can be changed at any time.
			/// </summary>
			MAKE_HINT(RETURN_KEY_HIDES_IME);
			...
			/// On targets where this is not supported, this hint does nothing.
			/// </summary>
			MAKE_HINT(SCREENSAVER_INHIBIT_ACTIVITY_NAME);
			...
			/// </summary>
			MAKE_HINT(THREAD_FORCE_REALTIME_TIME_CRITICAL);
			...
			/// </summary>
			MAKE_HINT(THREAD_PRIORITY_POLICY);
			...
			/// </summary>
			MAKE_HINT(VITA_TOUCH_MOUSE_DEVICE);
			...
			/// </summary>
			MAKE_HINT(TV_REMOTE_AS_JOYSTICK);
			...
			/// </summary>
			MAKE_HINT(VIDEO_ALLOW_SCREENSAVER);
			...
			/// </summary>
			MAKE_HINT(VIDEO_EGL_ALLOW_TRANSPARENCY);
			...
			/// </summary>
			MAKE_HINT(VIDEO_EXTERNAL_CONTEXT);

			/// <summary>
			/// \brief If set to 1, then do not allow high-DPI windows. ("Retina" on Mac and iOS)
			/// </summary>
			MAKE_HINT(VIDEO_HIGHDPI_DISABLED);
			...
			/// </summary>
			MAKE_HINT(VIDEO_MAC_FULLSCREEN_SPACES);
			...
			/// </summary>
			MAKE_HINT(VIDEO_MINIMIZE_ON_FOCUS_LOSS);
			...
			/// </summary>
			/// <param name=""></param>
			MAKE_HINT(VIDEO_WAYLAND_ALLOW_LIBDECOR);
			...
			///  libdecor is used over xdg-shell when xdg-decoration protocol is unavailable.
			/// </summary>
			MAKE_HINT(VIDEO_WAYLAND_PREFER_LIBDECOR);
			...
			/// </summary>
			MAKE_HINT(VIDEO_WAYLAND_MODE_EMULATION);
			...
			/// 
			/// This variable can be set to the following values:
			///   The address (as a string "%p") of the SDL_Window* that new windows created with SDL_CreateWindowFrom()
			/// should
			///   share a pixel format with.
			/// </summary>
			MAKE_HINT(VIDEO_WINDOW_SHARE_PIXEL_FORMAT);
			...
			/// </summary>
			MAKE_HINT(VIDEO_FOREIGN_WINDOW_OPENGL);
			...
			/// </summary>
			MAKE_HINT(VIDEO_FOREIGN_WINDOW_VULKAN);
			...
			/// </summary>
			MAKE_HINT(VIDEO_WIN_D3DCOMPILER);
			...
			/// </summary>
			MAKE_HINT(VIDEO_X11_NET_WM_BYPASS_COMPOSITOR);
			...
			/// </summary>
			MAKE_HINT(VIDEO_X11_NET_WM_PING);

			/// <summary>
			/// \brief  A variable forcing the visual ID chosen for new X11 windows
			/// </summary>
			/// <param name=""></param>
			MAKE_HINT(VIDEO_X11_WINDOW_VISUALID);
			...
			/// </summary>
			MAKE_HINT(WAVE_RIFF_CHUNK_SIZE);
			...
			/// </summary>
			MAKE_HINT(WINDOWS_DISABLE_THREAD_NAMING);
			...
			/// </summary>
			MAKE_HINT(WINDOWS_ENABLE_MESSAGELOOP);
			...
			/// </summary>
			MAKE_HINT(WINDOWS_FORCE_MUTEX_CRITICAL_SECTIONS);
			...
			/// </summary>
			MAKE_HINT(WINDOWS_FORCE_SEMAPHORE_KERNEL);

			/// <summary>
			/// \brief A variable to specify custom icon resource id from RC file on Windows platform 
			/// </summary>
			/// <param name=""></param>
			MAKE_HINT(WINDOWS_INTRESOURCE_ICON);

			MAKE_HINT(WINDOWS_INTRESOURCE_ICON_SMALL);
			...
			/// </summary>
			MAKE_HINT(WINDOWS_NO_CLOSE_ON_ALT_F4);
			...
			/// available match.
			/// </summary>
			MAKE_HINT(WINDOWS_DPI_AWARENESS);
			...
			/// </summary>
			MAKE_HINT(WINDOW_FRAME_USABLE_WHILE_CURSOR_HIDDEN);
			...
			/// </summary>
			MAKE_HINT(WINDOW_NO_ACTIVATION_WHEN_SHOWN);
			...
			/// </summary>
			MAKE_HINT(WINRT_HANDLE_BACK_BUTTON);
			...
			/// </summary>
			MAKE_HINT(WINRT_PRIVACY_POLICY_LABEL);
			...
			/// </summary>
			/// <param name=""></param>
			MAKE_HINT(WINRT_PRIVACY_POLICY_URL);
			...
			/// </summary>
			MAKE_HINT(X11_FORCE_OVERRIDE_REDIRECT);
			...
			/// </summary>
			MAKE_HINT(XINPUT_USE_OLD_JOYSTICK_MAPPING);
			...
			/// always ignored.
			/// </summary>
			MAKE_HINT(AUDIO_INCLUDE_MONITORS);
			...
			/// </summary>
			MAKE_HINT(QUIT_ON_LAST_WINDOW_CLOSE);
			...
			/// This hint is available since SDL 2.24.0.
			/// </summary>
			MAKE_HINT(TRACKPAD_IS_TOUCH_ONLY);
		};

		/// <summary>
		/// An enumeration of hint priorities.
		/// </summary>
		public enum class HintPriority
		{
			/// <summary>
		...
		public:
			...
			/// <returns>The string value of a hint or None if the hint isn't
			/// set.</returns>
			static Result<System::String^, None^> GetHint(SDLHint name);

			/// <summary>
			/// Get the boolean value of a hint variable.
			/// </summary>
			/// <param name="name">The name of the hint to get the boolean value
			/// from.</param>
			/// <param name="defaultValue">The value to return if the hint does
			/// not exist.</param>
			...
			static bool SetHint(SDLHint name, System::String^ value);
			...
			/// <param name="name">The hint to set.</param>
			/// <param name="value">The value of the hint variable.</param>
			/// <param name="priority">The priority level for the hint.
			/// </param>
			/// <returns>true if the hint was set, false otherwise.</returns>
			static bool SetHintWithPriority(SDLHint name, System::String^ value, HintPriority priority);
		};
	}
}